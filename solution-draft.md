# Solution Draft — v7
Status: IN-PROGRESS
Last edited by: Sonnet5, round 4
...
- **Cartosat-2S / Cartosat-3 (ISRO):** a concrete answer to the India/generalization gap below. Cartosat-3 delivers ~1.12m multispectral (0.25–0.28m panchromatic); Cartosat-2S delivers ~2m multispectral (~0.65m panchromatic) — both genuinely sub-4m and captured over Indian territory. Source: https://www.eoportal.org/satellite-missions/cartosat-3
  ...
  - **Cost and turnaround (round 4, concrete numbers):** under India's 2023 Space Policy, data finer than 5m is open/free for Indian **Government Entities** (with a submitted declaration) and **priced for Non-Government Entities**. A 17×17km Cartosat-3 scene (0.3m) is priced at ~₹3,860 for NGE users — modest, not a meaningful budget blocker for a hackathon team. Ordering requires a separate NSIL account (request by email to eodata@nsilindia.co.in); "urgent" orders can be fulfilled in 5–6 hours for a 50% surcharge, though normal-priority turnaround isn't documented in what was found this round. Sources: https://www.nsilindia.co.in/news-details/614 ; https://aidigitalnews.com/ai/why-isros-bhoonidhi-is-on-par-with-nasas-datasets/ ; https://bhoonidhi.nrsc.gov.in/imgarchive/bhoonidhi_videos_help/Commercial_Products_FAQ.pdf
  - If the team is affiliated with a recognized Indian academic/government institution, it's worth checking GE (Government Entity) declaration eligibility before assuming NGE pricing applies — GE access to >5m data is free.
  - **(assumption, unverified):** no ready-made paired Cartosat↔Sentinel-2 LR-HR dataset exists publicly — building one (co-registration + harmonization, similar in spirit to SEN2NAIP's pipeline) is new work. Normal-priority order turnaround should still be confirmed directly (e.g. a test order early) rather than assumed from the urgent-tier number above.
...
5. **India/generalization (updated, round 4):** ISRO's Cartosat-2S/3, accessible via the Bhoonidhi portal, provide a credible Indian-geography sub-4m source. Cost is now known and modest (~₹3,860 for a Cartosat-3 scene as a Non-Government Entity; free for Government Entities with a declaration) — this is no longer a plausible budget blocker. What's still unverified: normal-priority order turnaround time (urgent 5–6hr service exists at a surcharge, but standard timing wasn't found), NSIL account setup lead time, and building a Cartosat↔Sentinel-2 pairing pipeline from scratch, since no ready-made one exists. Recommend placing a test order early rather than assuming timing.
...
- Bhoonidhi/NSIL pricing policy: https://www.nsilindia.co.in/news-details/614 ; https://bhoonidhi.nrsc.gov.in/imgarchive/bhoonidhi_videos_help/Commercial_Products_FAQ.pdf
- Cartosat-3 sample pricing: https://aidigitalnews.com/ai/why-isros-bhoonidhi-is-on-par-with-nasas-datasets/
