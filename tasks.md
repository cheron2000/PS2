...
| T2 | Loss functions: reconstruction loss (L1/L2) + heteroscedastic NLL loss for the uncertainty head, combined into one training loss with configurable weighting | S | IN-PROGRESS | astrasr | T1 (needs output shapes) | `src/losses.py` | Claimed by AstraSR. |
